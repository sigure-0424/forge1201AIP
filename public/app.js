...
const ACTION_FIELDS = {
    ...
    equip:   [{ key:'target', ph:'item name' }],
    craft:   [{ key:'target', ph:'item name' }, { key:'quantity', ph:'qty', type:'num' }],
    place:   [{ key:'target', ph:'item/block name' }, { key:'x', ph:'x', type:'num' }, { key:'y', ph:'y', type:'num' }, { key:'z', ph:'z', type:'num' }],
    eat:     [{ key:'target', ph:'food item (opt)' }],
    smelt:   [{ key:'target', ph:'item to smelt' }, { key:'quantity', ph:'qty', type:'num' }, { key:'timeout', ph:'timeout(s)', type:'num' }],
