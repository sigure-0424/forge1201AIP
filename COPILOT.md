# COPILOT.md - Project Instructional Context (GitHub Copilot CLI)

This document serves as the primary instructional context for GitHub Copilot CLI when operating within the **Minecraft Forge 1.20.1 AI Player System (Forge1201AIP)** project.
